...
import static com.example.gamersgate.MainActivity.widget;
...
public class FavWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setTextViewText(R.id.widgetid, widgetText);
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            if (widget != null)
                views.setTextViewText(R.id.widgetid, widget.substring(4));
